...
function getData(url){
  ...
  switch (path){
    //获取订单详细信息（顾客）
    case host + '/getSession':
      return { "third_session":"third_session_test"};
    case host + '/getOrderDetail':
      return {
    ...
    case host + '/getOrders':
      return [
        { 'orderNo':'SXD000000000001','order      Time': '2018-02-12 10:00', 'sum': '￥17.00', 'cnt': 1 },
    ...
    //获取订单统计信息（店员）
    case host + '/getWaiterOrderSts':
      return { 'chked': 20, 'done': 18, 'taked': 16, 'untake': 2 };
    //获取订单列表（店员） 状态:0已确认 1待取餐 2已取餐 3未取餐  
    case host + '/getWaiterOrderList':
      return [
        {
          'orderNo': 'C001-180213-001', 'takeNo': 'C001', 'status': '2', 'statusName': '已取餐', 'orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
          ]
        },
        {
          'orderNo': 'C001-180213-001', 'takeNo': 'C001', 'status': '3', 'statusName': '未取餐', 'orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
          ]
        },
        {
          'orderNo': 'C001-180213-001', 'takeNo': 'C001', 'status': '1', 'statusName': '待取餐', 'orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
          ]
        },
        {
          'orderNo': 'C001-180213-001', 'takeNo': 'C001', 'status': '0', 'statusName': '待制作', 'orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
          ]
        }
      ];
    //获取订单统计信息（客服） 
    case host + '/getServiceOrderSts':
      return { 'all':50,'unChk':22,'unCancel':2,'chked':21,'canceled':6,};
    //获取订单列表（客服） 状态:0->1未确认 1->2已确认 2->6已取消 opType:0申请确认 1申请取消 （1未确认 2已确认 3完成 4未取餐 5 已取餐 6取消）
    case host + '/getServiceOrderList':
      return [
        {
          'orderNo': 'SXD000000000004', 'status': '0', 'orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'opName': '申请取消', 'opType': '1', 'customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
            ]
          } ,
        {
          'orderNo': 'SXD000000000002', 'status': '0', 'orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'opName': '申请确认', 'opType': '0','customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
            ]
          },
                  { 'orderNo': 'SXD000000000001','status':'1','orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'opName':'申请确认','opType':'0', 'customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }, 
            { 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 },
            { 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
        ]},
        {
          'orderNo': 'SXD000000000003', 'status': '2', 'orderTime': '2018-02-12 10:00', 'sum': '￥17.00', 'opName': '申请确认', 'opType': '0', 'customerName': '顾客名称', 'orderTime': '2018-02-02 10:00', 'takeTime': '2018-02-11 16:00', 'memo': '', 'foodList': [{ 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 },
            { 'name': '芒果益菌多/中杯', 'cnt': 1, 'list_price': 17 }
            ]
          } ,
        {
    ...
    case host + '/getChefOrderList':
      return [{
        ...
        "foods": [{
          ...
          "uptime": '2018-02-11 10:00',
          'orderList': [{ 'orderNo': 'C001-180213-001', 'takeTime': '2018-02-02 02:00', 'memo': '' },
          { 'orderNo': 'C001-180213-001', 'takeTime': '2018-02-02 02:00', ' ': '' }]
          }, {
